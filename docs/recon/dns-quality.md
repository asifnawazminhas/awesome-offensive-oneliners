...
```
**Tool:** dig/openssl · **Platform:** Linux/macOS · **Tags:** Wildcard DNS · **Context:** No auth · **Noise:** Moderate

## dnsx wildcard filtering
```bash
dnsx -l subdomains.txt -silent -wd <DOMAIN>
```
**Tool:** dnsx · **Platform:** Linux/macOS · **Tags:** Wildcard, DNS · **Context:** No auth · **Noise:** Moderate

## Validate resolver list with massdns
```bash
massdns -r resolvers.txt -t A -o S -w resolver-test.txt known-hosts.txt
```
**Tool:** massdns · **Platform:** Linux/macOS · **Tags:** Resolvers, Validation · **Context:** Local · **Noise:** Moderate
...
```
**Tool:** PureDNS · **Platform:** Linux/macOS · **Tags:** DNS, Resolvers · **Context:** Local · **Noise:** Moderate

## Remove unresolved candidates
```bash
dnsx -l subdomains.txt -silent -a -resp-only | sort -u
```
**Tool:** dnsx · **Platform:** Linux/macOS · **Tags:** DNS, Validation · **Context:** No auth · **Noise:** Moderate
