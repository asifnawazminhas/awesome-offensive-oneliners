...
```
**Tool:** ActiveDirectory module · **Platform:** Windows · **Tags:** Recycle Bin, AD · **Context:** Domain user · **Noise:** Quiet
...
```
**Tool:** ActiveDirectory module · **Platform:** Windows · **Tags:** Deleted Objects, Users · **Context:** Domain user · **Noise:** Quiet
...
```
**Tool:** ActiveDirectory module · **Platform:** Windows · **Tags:** Deleted Objects · **Context:** Domain user · **Noise:** Quiet
...
```
**Tool:** ldapsearch · **Platform:** Linux · **Tags:** LDAP, Deleted Objects · **Context:** Domain user · **Noise:** Quiet
