...
```
**Tool:** ActiveDirectory module · **Platform:** Windows · **Tags:** FGPP, Password Policy · **Context:** Domain user

## Resultant policy for a user
```powershell
Get-ADUserResultantPasswordPolicy -Identity '<USER>'
```
**Tool:** ActiveDirectory module · **Platform:** Windows · **Tags:** FGPP, User · **Context:** Domain user

## PSO subjects
```powershell
Get-ADFineGrainedPasswordPolicySubject -Identity '<PSO_NAME>'
```
**Tool:** ActiveDirectory module · **Platform:** Windows · **Tags:** FGPP, Subjects · **Context:** Domain user
...
```
**Tool:** ldapsearch · **Platform:** Linux · **Tags:** LDAP, FGPP · **Context:** Domain user

## NetExec domain password policy
```bash
nxc smb <DC_IP> -u '<USER>' -p '<PASSWORD>' --pass-pol
```
**Tool:** NetExec · **Platform:** Linux · **Tags:** Password Policy, SMB · **Context:** Domain user
