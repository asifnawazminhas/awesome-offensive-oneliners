...
```
**Tool:** curl · **Platform:** Any · **Tags:** XXE, XML · **Context:** No auth
...
```
**Tool:** curl · **Platform:** Any · **Tags:** XXE, Windows · **Context:** No auth
...
```
**Tool:** curl · **Platform:** Any · **Tags:** XXE, OOB · **Context:** No auth
...
```
**Tool:** curl · **Platform:** Any · **Tags:** SOAP, XXE · **Context:** No auth
